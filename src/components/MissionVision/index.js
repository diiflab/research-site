...
const MissionVisionList = [
  {
    ...
    description: (
      <>
      At AINTLab , our mission is to advance the science and application of AI, ML, & DS to create intelligent, sustainable, and interconnected systems for the future.

      <br/><br/>We explore the intersection of <b>AI, DS, and intelligent systems</b>, developing technologies that empower people, improve efficiency, and address pressing global challenges — from smart cities and IoT to green computing and advanced AI.
...
AINTLab aims to be a hub of interdisciplinary research and collaboration — where curiosity meets purpose, and where ideas grow into technologies that shape tomorrow’s connected society.
<br/><br/>
We are committed to:
<br/>
        <ul>
        <li>Advancing <b>AI and intelligent technologies</b> that are explainable, and scalable.</li>
