...
-	CKD Detection with AI (Airlangga University, 2025~2026, *Foreign Collaborator*)
-	Utilizing Artificial Intelligence for Research and Learning Innovation in Higher Education (Brawijaya University, 2026, *Foreign Collaborator*)
-	Joint Supervision and publication of comprehensive analysis of pharmaceutical companies (Diponegoro University, 2025~2026, *Foreign Collaborator*)
-	Integration of Internet of Things Sensors and Deep Learning-Based Image Analysis for Struck Pipe Prediction in Geothermal and Oil and Gas Drilling (Gadjah Mada University, 2025~2026, *Foreign Collaborator*)
-	Development of a Hybrid RFID-NFC-QR Smart Livestock Monitoring System with IoT Methane Gas Sensor Integration to Support Food Security (Gadjah Mada University, 2025~2026, *Foreign Collaborator*)
