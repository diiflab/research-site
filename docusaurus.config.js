...
const config = {
  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
        style: 'dark',
        copyright: `Copyright © 2019-${new Date().getFullYear()} Applied INTelligence Lab (AINTLab), Department of Artificial Intelligence and Data Science, Sejong University, Seoul 05006, Republic of Korea; Lead by <a href="https://muhammadsyafrudin.com/" style="color:white"target="_blank">Muhammad Syafrudin</a>. Built with Docusaurus.`,
      },
      prism: {
