...
const config = {
  ...
  plugins: [
    ...
    [
      ...
      require.resolve('./plugins/blog-plugin'),
      {
        ...
        feedOptions: {
          type: 'all',
          copyright: `Copyright © ${new Date().getFullYear()} Applied INtelligence (AIN) Lab; Lead by Muhammad Syafrudin.`,
        },
      },
    ],
  ],
  ...
  themeConfig:{
    ...
    metadata: [
      ...
      {name: 'twitter:card', content: 'Applied INtelligence (AIN) Lab is not only a laboratory but also a playground to learn and explore things related to applied intelligence. We explore the frontier of artificial intelligence, data science, and intelligent systems. We design AI-driven solutions that connect systems, enhance communication, and promote sustainability. Through collaboration across academia and industry, we aim to build systems that shape a smarter, more connected world. AIN Lab is a hub for learning and innovation in applied intelligence and IoT. Pioneering Artificial Intelligence research, AIN Lab focuses on machine learning, deep learning, IoT, and self-supervised learning. Our expertise drives agricultural innovation, vessel detection, human action recognition, and predictive analytics, promoting sustainable agriculture and global food security. Explore our extensive collection of research publications on AI, machine learning, IoT, and sustainable agriculture, featuring groundbreaking work on transformer models, predictive analytics, and more.'},
      {name: 'description', content: 'Applied INtelligence (AIN) Lab is not only a laboratory but also a playground to learn and explore things related to applied intelligence. We explore the frontier of artificial intelligence, data science, and intelligent systems. We design AI-driven solutions that connect systems, enhance communication, and promote sustainability. Through collaboration across academia and industry, we aim to build systems that shape a smarter, more connected world. AIN Lab is a hub for learning and innovation in applied intelligence and IoT. Pioneering Artificial Intelligence research, AIN Lab focuses on machine learning, deep learning, IoT, and self-supervised learning. Our expertise drives agricultural innovation, vessel detection, human action recognition, and predictive analytics, promoting sustainable agriculture and global food security. Explore our extensive collection of research publications on AI, machine learning, IoT, and sustainable agriculture, featuring groundbreaking work on transformer models, predictive analytics, and more.'},
      {name: 'og:image',content: 'https://ain.my.id/img/social-media.png'},
    ...
    /** @type {import('@docusaurus/preset-classic').ThemeConfig} */
      navbar: {
        title: '',
        logo: {
          alt: 'Applied INtelligence (AIN) Lab is not only a laboratory but also a playground to learn and explore things related to applied intelligence. We explore the frontier of artificial intelligence, data science, and intelligent systems. We design AI-driven solutions that connect systems, enhance communication, and promote sustainability. Through collaboration across academia and industry, we aim to build systems that shape a smarter, more connected world.',
          src: '/img/favicon.svg',
      ...
      footer: {
        ...
        copyright: `<div class="footer-shell">
          ...
          <p class="footer-copy">Copyright © ${new Date().getFullYear()} Applied INtelligence (AIN) Lab; Lead by Muhammad Syafrudin. <br/>Built with <a href="/credits">Docusaurus & others.</a> Assisted with 🤖. <span>Follow us on</span>
            <a class="footer-social" href="https://www.linkedin.com/company/ainlab" target="_blank" rel="noopener noreferrer" aria-label=" LinkedIn">
              <svg role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <title>Applied INtelligence (AIN) Lab @ LinkedIn</title>
