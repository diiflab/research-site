...
const config = {
  title: 'Applied INTelligence Lab (AINTLab) - 아인트랩',
  tagline: '"AINTLab" is not only a laboratory but also a playground to learn and explore the frontier of artificial intelligence (AI), machine learning (ML), data science (DS), and intelligent technologies.',
    ...
    [
      ...
      ({
        ...
        blog: {
          ...
          feedOptions: {
            type: 'all',
            copyright: `Copyright © 2019-${new Date().getFullYear()} Applied INTelligence Lab (AINTLab) - 아인트랩; Lead by Muhammad Syafrudin.`,
          },
        },
        theme: {
  ...
  themeConfig:{
    ...
    headTags: [
      // Declare some json-ld structured data
      {
        ...
        innerHTML: JSON.stringify({
          ...
          url: 'https://aintlab.com/',
          description: 'Applied INTelligence Lab (AINTLab) - 아인트랩 - AINTLab.com - 아인트랩 is not only a laboratory but also a playground to learn and explore the frontier of artificial intelligence, data science, and intelligent networks. We design AI-driven solutions that connect systems, enhance communication, and promote sustainability. Through collaboration across academia and industry, we aim to build technologies that shape a smarter, more connected world. AINTLab is a hub for learning and innovation in applied intelligence and IoT. Pioneering Artificial Intelligence research, AINTLab focuses on machine learning, deep learning, IoT, and self-supervised learning. Our expertise drives agricultural innovation, vessel detection, human action recognition, and predictive analytics, promoting sustainable agriculture and global food security. Explore our extensive collection of research publications on AI, machine learning, IoT, and sustainable agriculture, featuring groundbreaking work on transformer models, predictive analytics, and more.',
          foundingDate: '2019',
          founder: {
            '@type': 'Person',
    ...
    /** @type {import('@docusaurus/preset-classic').ThemeConfig} */
      navbar: {
        title: '',
        logo: {
          alt: '"AINTLab" - 아인트랩" is not only a laboratory but also a playground to learn and explore the frontier of artificial intelligence, data science, and intelligent networks. We design AI-driven solutions that connect systems, enhance communication, and promote sustainability. Through collaboration across academia and industry, we aim to build technologies that shape a smarter, more connected world.',
      ...
      footer: {
        style: 'dark',
        copyright: `Copyright © 2019-${new Date().getFullYear()} <a href="https://aintlab.com/" style="color:white"target="_blank">Applied INTelligence Lab (AINTLab) - 아인트랩</a>; Lead by <a href="https://muhammadsyafrudin.com/" style="color:white"target="_blank">Muhammad Syafrudin</a>. Built with Docusaurus. <br/>(🇰🇷) Applied INTelligence Lab (AINTLab), Seoul 05006, Republic of Korea | (🇮🇩) Applied INTelligence Lab (AINTLab), Yogyakarta 55187, Indonesia.
        <br/> <a href="/team" style="color:white"target="_blank">The Team</a> / <a href="/projects" style="color:white"target="_blank">Projects</a> / <a href="/publications" style="color:white"target="_blank">Publications</a> / <a href="/contact" style="color:white"target="_blank">Contact</a> | Follow us on <a class="link" href="https://www.linkedin.com/company/aintlab" target="_blank" data-tippy-content="LinkedIn">
